...
public class PersonRepository {
    ...
    public PersonRepository(){
        List<Person> list = List.of(
                new Person(1,"Lưu Đặng Phổ","Developer",true,"1999-10-26"),
                new Person(2,"Mary Jane","Banker",false,"1980-05-24"),
                new Person(3,"Tom Sawyer","Taxi Driver",true,"1990-08-09"),
                new Person(4,"Nguyen Thi A","Developer",false,"1992-05-21"),
                new Person(5,"Nguyen Thi B","Idiot",false,"1992-05-21")
